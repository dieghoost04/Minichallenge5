...
class AutonomousNav():  
    def __init__(self):  
        ...
        stop_distance = 0.25 # distance from closest obstacle to stop the robot [m] 
            ...
            if self.lidar_received:
                ...
                if self.current_state == 'Stop': 
                    ...
                    if self.at_goal() or  closest_range <  stop_distance:  
                        ...
                        print("Change to Avoid Obstacles from Go to goal") 
                    ...
                    elif self.at_goal() or closest_range < stop_distance: 
    ...
    #returns  closest_range [m], closest_angle [rad], 
        ...
        cropped_ranges = lidar_msg.ranges[ranges_size//4:3*ranges_size//4]  # Cambia / por //
